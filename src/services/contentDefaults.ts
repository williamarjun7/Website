export const CONTENT_DEFAULTS: Record<string, string> = {
    ...
    // SEO - Home
    home_meta_title: 'Highlands Cafe & Motel Inn | Home',
    home_meta_desc: 'Experience a warm, cozy stay at Highlands Cafe & Motel Inn in Surkhet. Book comfortable rooms and enjoy great food.',
    about_meta_title: 'About Us | Highlands Cafe & Motel Inn',
    about_meta_desc: 'Learn the story behind Highlands Cafe & Motel Inn in Surkhet.',
    contact_meta_title: 'Contact Us | Highlands Cafe & Motel Inn',
    contact_meta_desc: 'Get in touch. Call, email, or visit us in Surkhet, Nepal.',
    faq_meta_title: 'FAQ | Highlands Cafe & Motel Inn',
    faq_meta_desc: 'Find answers to frequently asked questions about booking, rooms, amenities, check-in/out, payments, and more.',
    rooms_meta_title: 'Rooms | Highlands Cafe & Motel Inn',
    rooms_meta_desc: 'Browse our comfortable rooms in Surkhet, Nepal.',
    cafe_meta_title: 'Cafe Menu | Highlands Cafe & Motel Inn',
    cafe_meta_desc: 'Savor authentic local cuisine at our cafe in Surkhet.',
    gallery_meta_title: 'Gallery | Highlands Cafe & Motel Inn',
    gallery_meta_desc: 'Explore our photo gallery showcasing rooms, cafe, exterior views, and the beautiful surroundings.',
    booking_meta_title: 'Book Your Stay | Highlands Cafe & Motel Inn',
    booking_meta_desc: 'Reserve your room at Highlands Cafe & Motel Inn in Surkhet.',
    terms_meta_title: 'Terms of Service | Highlands Cafe & Motel Inn',
    ...
    privacy_meta_title: 'Privacy Policy | Highlands Cafe & Motel Inn',

  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <Helmet>
        ...
        <meta name="description" content="Read the Terms of Service. Learn about booking policies, cancellation, payment terms, and guest responsibilities." />
      </Helmet>
      ...
      <div className="container-custom max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          {notFound ? (
            <p className="text-gray-500 text-center py-8">Terms of service content is being updated. Please check back later.</p>
          ) : (
